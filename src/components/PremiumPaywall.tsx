  ...
  const features = {
    sugestoes: {
      ...
      benefits: [
        ...
        "Links diretos para casas de apostas",
        "Histórico completo de acertos",
      ],
    },
    multiplas: {
      title: "Gerador de Múltiplas",
      description: "Acesse múltiplas exclusivas criadas por especialistas para potencializar seus ganhos.",
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      benefits: [
        "Múltiplas selecionadas por especialistas",
        "Odds combinadas de alto valor",
        "Atualizações em tempo real",
        "Bilhetes prontos para apostar",
      ],
    },
  };
    ...
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className={`max-w-lg w-full mx-4 rounded-3xl border ${cardBorder} ${cardBg} overflow-hidden shadow-2xl`}>
        ...
        <div className="p-8">
          ...
          <a
            href={checkoutUrl}
            className="block w-full py-4 px-6 rounded-xl font-bold text-center text-white bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 hover:from-amber-600 hover:via-orange-600 hover:to-rose-600 transition-all shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
          >
            Assinar Premium
          </a>
